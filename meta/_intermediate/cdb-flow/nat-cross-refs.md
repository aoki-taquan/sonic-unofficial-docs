...
- **場所**: `sonic-swss/orchagent/natorch.cpp:171-172,259-302,2573` `m_neighOrch->attach(this)` / `NatOrch::updateNeighbor()` L259-303
...
| RouteOrch observer (next-hop) | — | READ | DNAT エントリ追加/削除時 | **BRCM 専用** `natorch.cpp:414,2573` |
| NeighOrch observer (neighbor) | — | READ | enableNatFeature/disableNatFeature 時 | **BRCM 専用** `natorch.cpp:2573,2610` |
