...
- [HLD と実装の乖離 一覧（discrepancy-index）](verification/discrepancy-index.md) (246)
...
- [MUX_CABLE テーブル](config-db/mux-cable.md) (82)
- [MUX_CABLE_TABLE / HW_MUX_CABLE_TABLE (STATE_DB)](config-db/mux-cable-state.md) (64)
