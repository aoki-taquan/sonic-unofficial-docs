...
[^3]: [bgpcfgd](../../reference/glossary.md#term-bgpcfgd) static redistribution: `sonic-buildimage/src/sonic-bgpcfgd/bgpcfgd/managers_static_rt.py` L221-252. <https://github.com/sonic-net/sonic-buildimage/blob/master/src/sonic-bgpcfgd/bgpcfgd/managers_static_rt.py>
...
[SmartSwitch](../../reference/glossary.md#term-smartswitch) ([DPU](../../reference/glossary.md#term-dpu)) 構成において、frrcfgd / bgpcfgd は [NPU](../../reference/glossary.md#term-npu) 側ホストで通常通り動作し、ROUTE_REDISTRIBUTE 処理ロジックに変更はない。[SmartSwitch](../../reference/glossary.md#term-smartswitch) 固有の BGP 設定は別テーブル（`BGP_VOQ_CHASSIS_NEIGHBOR` 等）で管理される。
