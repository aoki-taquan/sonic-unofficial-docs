...
| [ASIC_DB](../../reference/glossary.md#term-asic_db) (SAI) | `SAI_OBJECT_TYPE_BRIDGE_PORT:<oid>` | `sai_bridge_api->create_bridge_port()` via `addBridgePort()` (portsorch.cpp:7258) | `addBridgePort()` 呼出と同期 |
...
| [ASIC_DB](../../reference/glossary.md#term-asic_db) (SAI) | `create_bridge_port()` 直接呼び出し via `addBridgePort()` (portsorch.cpp:7258) | SAI API 同期呼び出し | `addBridgePort()` と同期 |
