...
| [`ROUTE_MAP`](route-map.md) | 逆参照（[ROUTE_MAP](../../reference/glossary.md#term-route_map) が PREFIX_SET を leafref） | `match_prefix_set`, `match_next_hop_set` | PREFIX_SET 未作成時 frrcfgd が AF 解決失敗 → FRR コマンド未発行（silent drop）。`frrcfgd.py:2669-2676` |
