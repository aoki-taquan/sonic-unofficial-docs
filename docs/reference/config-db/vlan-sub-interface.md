...
| 3 | `vrf_name` 指定時は `VRF` テーブル + [vrfmgrd](../../reference/glossary.md#term-vrfmgrd)/VRFOrch 処理完了 | **先行必須** | [intfmgrd](../../reference/glossary.md#term-intfmgrd)・intfsorch どちらもリトライ待ち |
