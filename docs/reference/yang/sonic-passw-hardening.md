...
Password hardening policy [YANG](../../reference/glossary.md#term-yang) module for [SONiC](../../reference/glossary.md#term-sonic) OS. ローカルユーザパスワードの複雑さ・有効期限・履歴ポリシーを定義する。[^1]
