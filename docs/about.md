---
title: このドキュメントについて
description: "このドキュメントについて — 本ページは sonic-unofficial-docs プロジェクトの目的・スコープ・ライセンス・フィードバック窓口・貢献方法をまとめた概要ページです。トップページ (index.md) が「読み始める入口」であるのに対し、本ページは「プロジェクトの性格・規約」を集約する位置付けです。"
verification: meta
---
