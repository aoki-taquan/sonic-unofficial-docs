...
- `auto` にしても変わらない → `SAI_PORT_ATTR_AUTO_NEG_FEC_MODE_OVERRIDE` 対応 SAI か [portsorch](../reference/glossary.md#term-portsorch) ログで確認
...
redis-cli -n 0 hget 'PORT_TABLE:Ethernet0' fec
