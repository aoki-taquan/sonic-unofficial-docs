...
!!! warning "裏取りステータス: HLD-only"
    HLD は 2021 年 4 月版 (Phase 1)。`sonic-cli-gen` ツール、`sonic-package-manager` 連携、`config/plugins/auto/` および `show/plugins/auto/` への自動配置、`manifest.json` の `auto-generate-config/show` トリガ実装は未裏取り。
